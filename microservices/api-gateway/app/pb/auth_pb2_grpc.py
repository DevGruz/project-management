...
from app.pb import auth_pb2 as app_dot_pb_dot_auth__pb2
...
if _version_not_supported:
    warnings.warn(
        ...
        + f' but the generated code in app/pb/auth_pb2_grpc.py depends on'
...
class AuthServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.VerifyToken = channel.unary_unary(
                ...
                response_deserializer=app_dot_pb_dot_auth__pb2.VerifyResponse.FromString,
                _registered_method=True)
...
def add_AuthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'VerifyToken': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=app_dot_pb_dot_auth__pb2.VerifyResponse.SerializeToString,
            ),
    }
...
class AuthService(object):
    ...
    def VerifyToken(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            app_dot_pb_dot_auth__pb2.VerifyResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
